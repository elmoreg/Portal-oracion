        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('prayer.create')" :active="request()->routeIs('prayer.create')" wire:navigate>
                        {{ __('Nueva petición') }}
                    </x-nav-link>

                    @if (auth()->user()->isIntercessor())
                        <x-nav-link :href="route('intercessor.dashboard')" :active="request()->routeIs('intercessor.*')" wire:navigate>
                            {{ __('Orar') }}
                        </x-nav-link>
                    @endif
