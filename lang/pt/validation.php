...
return [
    ...
    */
    ...
    'encoding' => 'O campo :attribute deve ter uma codificação válida (:values).',
    ...
    'missing_unless' => 'O campo :attribute não deve estar presente a menos que :other seja :values.',
    ...
    */
    ...
    'attributes' => [
        ...
        'formEmail' => 'e-mail',
        'formPassword' => 'senha',
        'formPassword_confirmation' => 'confirmação da senha',
        'formRole' => 'papel',
        'answer_note' => 'testemunho ou resposta',
        'status' => 'status',
        'form.email' => 'e-mail',
        'form.password' => 'senha',
    ],
